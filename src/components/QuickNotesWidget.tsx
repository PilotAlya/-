...
const STORAGE_DRAFT_KEY = 'aurelia_chat_scratchpad';
const STORAGE_ACTIONS_KEY = 'aurelia_chat_quick_actions';
const STORAGE_IMAGES_KEY = 'aurelia_chat_attached_images';
const STORAGE_AUDIO_KEY = 'aurelia_chat_audio_memo';
const STORAGE_COLLAPSED_KEY = 'aurelia_chat_widget_collapsed';
...
const CHAT_TEMPLATES = [
  {
    ...
    suggestedActions: [
      ...
      'Проверить статус заказа в «Нексус»',
  ...
  },
  {
    ...
    suggestedActions: [
      ...
      'Проверить статус транзакции и холда в «Нексус»',
  ...
  },
  {
    ...
    suggestedActions: [
      ...
      'Попросить клиента перезайти в приложение «Аврелия»'
    ]
  }
];
...
export const QuickNotesWidget: React.FC = () => {
  ...
  const [actions, setActions] = useState<ChatActionItem[]>(() => {
    ...
    return [
      { id: 'act-1', text: 'Проверить заказ в «Нексус»', done: false },
